<div class="jumbotron ">
    <div class="container card">
        ...
        <div class="card-body justify-text">
            ...
            <div class="py-5">
                <p>These terms and conditions outline the rules and regulations for the use of Spring and Fall's
                    Website,
                    located at
            ...
            <h3 class="font-weight-bold"><strong>Cookies</strong></h3>

            <div class="py-5">
                <p>We employ the use of cookies. By accessing springandfall.in, you agreed to use cookies in agreement
                    with
                    the
                    Spring
                    and Fall's Privacy Policy. </p>
            ...
            <div class="py-5">
                <p>Unless otherwise stated, Spring and Fall and/or its licensors own the intellectual property rights
                    for
                    all
                    material
                    on springandfall.in. All intellectual property rights are reserved. You may access this from
                    springandfall.in
                    for
                ...
                <p>You must not:</p>
                <ul>
                    <li>Republish material from springandfall.in</li>
                    <li>Sell, rent or sub-license material from springandfall.in</li>
                    <li>Reproduce, duplicate or copy material from springandfall.in</li>
                    <li>Redistribute content from springandfall.in</li>
                </ul>
                ...
                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain
                    areas
                    of the website. Spring and Fall does not filter, edit, publish or review Comments prior to their
                    presence on
                    the
                    website. Comments do not reflect the views and opinions of Spring and Fall,its agents and/or
                    affiliates.
                    Comments
                    reflect the views and opinions of the person who post their views and opinions. To the extent
                    permitted
                    by
                    applicable laws, Spring and Fall shall not be liable for the Comments or for any liability, damages
                    or
                    expenses
                ...
                <p>Spring and Fall reserves the right to monitor all Comments and to remove any Comments which can be
                    considered
                ...
                <p>You hereby grant Spring and Fall a non-exclusive license to use, reproduce, edit and authorize others
                    to
                    use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                negative
                records
                with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Spring
                and
                Fall;
                and
            ...
            <p>These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b)
                does
                not
                falsely imply sponsorship, endorsement or approval of the linking party and its products or services;
                and
                (c)
                fits
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website,
                you
                must inform us by sending an e-mail to Spring and Fall. Please include your name, your organization
                name,
                contact
            ...
            <p>No use of Spring and Fall's logo or other artwork will be allowed for linking absent a trademark license
                agreement.
            </p>
            ...
            <p>We shall not be hold responsible for any content that appears on your Website. You agree to protect and
                ...
                interpreted
                as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement
                or
                other
            ...
            <p>We reserve the right to request that you remove all links or any particular link to our Website. You
                approve
                to
                immediately remove all links to our Website upon request. We also reserve the right to amen these terms
                and
