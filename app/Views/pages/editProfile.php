...
<div class="container">
    <div class="row gutters">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="account-settings">
                        ...
                        <div class="about">
                            <h5>About</h5>
                            <p>"<?= $userDetails[0]['highest_qualification'] ?>" Passing Year
                                "<?= $userDetails[0]['highest_qualification_passing_year'] ?>"</p>
                            <p>"<?= $userDetails[0]['higher_secondary'] ?>" Passing Year
                                "<?= $userDetails[0]['higher_secondary_passing_year'] ?>"</p>
                            <p>"<?= $userDetails[0]['secondary'] ?>" Passing Year
                                "<?= $userDetails[0]['secondary_passing_year'] ?>"</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
            <div class="card h-100">
                <div class="card-body">
                    <div class="row gutters" id="personalProfileDetails" style="display:inline">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profileFullName"
                                    placeholder="Enter full name" value="<?= $userDetails[0]['name'] ?>">
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profilePhone"
                                    placeholder="Enter phone number" value="<?= $userDetails[0]['phone'] ?>">
                            </div>
                        </div>
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profileHQ"
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profileHQY"
                                    placeholder="Enter Highest Qualification Year"
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profileHS"
                                    placeholder="Enter Higher Secondary"
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profileHSY"
                                    placeholder="Enter Higher Secondary Year"
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profileSY"
                                    placeholder="Enter Secondary Year"
