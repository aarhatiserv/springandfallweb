    ...
    <div class="row">
        <div class="col-lg-2 col-sm-6 col-xs-12 firstCol text-center">
            ...
            <div class="social-icons-fa p-2 mr-3 pb-4">
                <a href="http://www.facebook.com/springnfall/" target="_blank" rel="noopener"><i class="fa fa-facebook-square ml-4 mt-2 fa-2x" title="facebook"></i></a>
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-12" id="subscribe-area">
                    ...
                    <div class="appPlay pt-2">
                        <img src="<?= base_url() ?>/assets/images/mobilestores.png" alt="mobilestores" width="180" height="100" title="mobilestores" />
                    </div><br>
