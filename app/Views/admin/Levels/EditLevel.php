                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="/admin/editLevel" method="POST">
                                        <input type="hidden" name="id" value="<?= $levelDatabyId[0]['id']?>" />
                                        <div>

                                            <label for="name" style="margin-right:252px">Level Name</label>
                                            <br>

                                            <input type="text" id="name" name="name" placeholder="Name..."
                                                value="<?= $levelDatabyId[0]['name']?>" required />
                                        </div>

                                        <br>

                                        <button class="back"><a href="/admin/level" class="back">Back</a>
                                        </button>
