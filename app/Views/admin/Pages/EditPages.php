                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="/admin/editPages" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?= $pagesDatabyId[0]['id']?>" />
                                        <div>

                                            <label for="name" style="margin-right:252px">Pages Name</label>
                                            <br>

                                            <input type="text" id="name" name="name"
                                                placeholder="Name..." value="<?= $pagesDatabyId[0]['name']?>"
                                                required />
                                        </div>
