                                ...
                                <div class="x_content">
                                    <form action="/admin/editUser" method="POST">
                                        ...
                                        <div>
                                            ...
                                            <label for="email" style="margin-right:267px">Email</label>
                                            <label for="phone" style="margin-right: 221px;">Phone No</label>
                                            <!-- <label for="person">Person</label> -->
                                            <br>

                                            <input type="text" id="name" name="name" placeholder="Name..."
                                                style="margin-right:50px" value="<?= $userDatabyId[0]['name']?>"
                                                required />
                                        ...
                                        <div>
                                            ...
                                            <label for="city" style="margin-right:252px">City</label>
                                            <label for="state" style="margin-right:267px">State</label>
                                            <label for="pin" style="margin-right: 221px;">Pin Code</label>
                                            <!-- <label for="person">Person</label> -->
                                            <br>
                                        ...
                                        <div>
                                            ...
                                            <label for="hq" style="margin-right:252px">Highest Qualification</label>
                                            <label for="hqy" style="margin-right:267px">Highest Qualification
                                                Year</label>

                                            <!-- <label for="person">Person</label> -->
                                            <br>

                                            <input type="text" id="hq" name="hq" placeholder="Highest Qualification"
                                                style="margin-right:50px"
                                                value="<?= $userDatabyId[0]['highest_qualification']?>"  />

                                            <input type="text" id="hqy" name="hqy"
                                                placeholder="Highest Qualification Year" style="margin-right:50px"
                                                value="<?= $userDatabyId[0]['highest_qualification_passing_year']?>"
                                                 />
                                        ...
                                        <div>
                                            ...
                                            <label for="hs" style="margin-right:252px">Higher Secondary</label>
                                            <label for="hsy" style="margin-right:267px">Higher Secondary Passing
                                                Year</label>
                                            <!-- <label for="person">Person</label> -->
                                            <br>

                                            <input type="text" id="hs" name="hs" placeholder="Higher Secondary"
                                                style="margin-right:50px"
                                                value="<?= $userDatabyId[0]['higher_secondary']?>"  />

                                            <input type="text" id="hsy" name="hsy"
                                                placeholder="Higher Secondary Passing Year" style="margin-right:50px"
                                                value="<?= $userDatabyId[0]['higher_secondary_passing_year']?>"
                                                 />
                                        ...
                                        <div>
                                            ...
                                            <label for="s" style="margin-right:252px">Secondary</label>
                                            <label for="sy" style="margin-right:267px">Secondary Passing
                                                Year</label>
                                            <!-- <label for="person">Person</label> -->
                                            <br>

                                            <input type="text" id="s" name="s" placeholder="Secondary"
                                                style="margin-right:50px"
                                                value="<?= $userDatabyId[0]['secondary']?>" />

                                            <input type="text" id="sy" name="sy"
                                                placeholder="Secondary Passing Year" style="margin-right:50px"
                                                value="<?= $userDatabyId[0]['secondary_passing_year']?>"
                                                 />

                                        </div>
                                        <br>
                                        <button class="back"><a href="/admin/user" class="back">Back</a>
                                        </button>
