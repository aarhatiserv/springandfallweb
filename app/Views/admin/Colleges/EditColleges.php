                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                                    aria-expanded="false">
                                    <img src="../../assets/backend/production/images/img.jpg" alt="">John Doe
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form action="/admin/editCollege" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" name="id" value="<?= $collegeDatabyId[0]['id']?>" />
                                        <div>
                                            ...
                                            <input type="text" id="collegeName" name="collegeName"
                                                ...
                                                value="<?= $collegeDatabyId[0]['names']?>" required />

                                            <input type="text" id="url" name="url" placeholder="Website Link"
                                                style="margin-right:50px" value="<?= $collegeDatabyId[0]['website']?>"
                                                required />
                                        ...
                                        <div>
                                            ...
                                            <select id="country" name="country" style="margin-right:50px" required>
                                                <option value="<?= $collegeDatabyId[0]['country']?>" selected
                                                    hidden>
                                                    <?= strtoupper($collegeDatabyId[0]['country'])?>
                                                </option>
                                        ...
                                        <div>
                                            ...
                                            <textarea name="address" id="address" rows="6" cols="70"
                                                placeholder="Enter Address Here..." style="margin-right:50px" required><?= $collegeDatabyId[0]['address']?>
</textarea>
                                            <textarea name="about" id="about" rows="6" cols="70"
                                                placeholder="Enter About Here..." required><?= $collegeDatabyId[0]['about']?>
</textarea>
                                        </div>
