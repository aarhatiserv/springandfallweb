...
class UserController extends Controller
{
    ...
    public function getLastTwoDaysDataUserDetails()
    {
        ...
        // $model = new UserModel();
        // $data = $model->where("registered >= ", $this->request->getVar("filter"), "AND", $CurrDate, ">", $this->request->getVar("filter") )->findAll();
        
        $db = \Config\Database::connect();
        $query = $db->query("SELECT * FROM spring_users WHERE registered >=".'"$this->request->getVar("filter")"'."AND".'"$CurrDate"'. "<".'"$this->request->getVar("filter")"');
